...
alexia = Employee.create!(first_name: "Alexia", last_name: "Roux", job_title: "Rouleuse de cigarette les yeux fermés", price_per_day: 60, user: tintin, description: "Alexia roule des cigarettes les yeux fermés depuis l'âge de 10 ans. Tout a commencé lorsqu'elle a perdu un pari avec ses amis et depuis, elle a développé une technique infaillible pour rouler des cigarettes les yeux fermés. Elle est disponible pour vous apprendre cette technique. ");
...
gerard = Employee.create!(first_name: "Gérard", last_name: "Perrin", job_title: "Joueur de piano sans les mains", price_per_day: 100, user: tintin, description: "Gérard est capable de jouer du piano sans les mains. C'est un talent qu'il a développé depuis l'âge de 5 ans lorsqu'il a perdu ses mains dans un accident. Il est disponible pour des concerts ou soirées privées et saura vous émerveiller avec son talent. Il est également disponible pour vous donner un petit coup de main pour apprendre à jouer.");
